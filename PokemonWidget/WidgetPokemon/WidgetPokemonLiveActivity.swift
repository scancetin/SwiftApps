...
struct WidgetPokemonLiveActivity_Previews: PreviewProvider {
    static let attributes = WidgetPokemonAttributes(name: "Me")
    static let contentState = WidgetPokemonAttributes.ContentState(value: 3)
